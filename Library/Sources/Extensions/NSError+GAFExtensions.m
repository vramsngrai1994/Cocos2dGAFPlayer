...
{
    return [[NSError alloc] initWithDomain:domain code:code description:description innerError:anInnerError];
}
...
{
    return [[NSError alloc] initWithDomain:domain code:code description:description];
}
...
{
    return [[NSError alloc] initWithDescription:aDescription innerError:anError];
}
